  ...
  return (
	...
	<main>
		<div className="container">
			<section>
				<h2>About Me</h2>
                <p>A highly motivated and enthusiastic fresh graduate student with a strong academic background in computer information systems. Possessing excellent communication and problem-solving skills, I am seeking an opportunity to apply my knowledge and contribute to a dynamic organization. With a dedication to continuous learning and a proactive approach, I am eager to make a positive impact in the organization and grow both professionally and personally.
                </p>
            </section>
            <section>
				<h2>Education</h2>
